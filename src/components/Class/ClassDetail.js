...
const ClassDetail = () => {
  ...
  useEffect( async () => {
    const res = await getfromClass('oana5uZDKz');
  ...
  <div className="container4">
      ...
      <div className=''>
        <div className='absolute p-5 truncate'>
          <h2 className=""> {content.class_name} </h2>
    ...
    <div className="p-5 break-all">
        <b>class code : </b>xxxxx<br />
        <b>subject : </b>xxxxx<br />
        <b>room : </b>xxxxx<br />
        <b>describe : </b>sdfffffffffffffffffffffffffffffffffffffffsssssssssssssssssssssss<br />
    </div>
      ...
      <div className='space-x-2 grid justify-items-center'>
        ...
        <label className='text-lg'>Firstname Lastname </label>
        </div>
